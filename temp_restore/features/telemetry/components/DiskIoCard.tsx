...
import { DiskIoPoint } from "../models";
import { formatBps } from "../format";

function toChart(series?: DiskIoPoint[]) {
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              ...
              <Tooltip
                ...
                formatter={(v: any, name) => [formatBps(Number(v)), name === "readBps" ? "Read" : "Write"]}
              />
              <Legend
                formatter={(v) => (v === "readBps" ? "Read" : "Write")}
